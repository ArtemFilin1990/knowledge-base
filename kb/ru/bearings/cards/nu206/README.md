---
id: KB-RU-000123
title: "NU206 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NU206 — подшипник роликовый цилиндрический
...
- **U** — серия ширины  (B = 16.0 мм для этого размера)
...
| NTN | NU206 |  |
| NSK | NU206 |  |
| ГОСТ | 32306 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NU206-2RS**: с уплотнениями — для загрязнённых условий
- **NU206-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- NU05 — другой d (25 мм вместо 30 мм) — не сядет на вал
- NU07 — другой d (35 мм вместо 30 мм) — не сядет на вал

---
id: KB-RU-000144
title: "30209 — подшипник роликовый конический"
topic: bearings-card
...
# 30209 — подшипник роликовый конический
...
**Режимы работы**:
- Обороты: 700–7000 об/мин (оптимум 700–2333)
...
**Предельные обороты**: 7000 об/мин (с консистентной смазкой; масляная: 9500 об/мин)
...
| NTN | 30209 |  |
| NSK | 30209 |  |
| ГОСТ | 7209 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **30209-2RS**: с уплотнениями — для загрязнённых условий
- **30209-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- 3008 — другой d (40 мм вместо 45 мм) — не сядет на вал
- 3010 — другой d (50 мм вместо 45 мм) — не сядет на вал
...
- Применение на оборотах выше 7000 → перегрев

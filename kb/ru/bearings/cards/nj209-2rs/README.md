---
id: KB-RU-000072
title: "NJ209-2RS — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NJ209-2RS — подшипник роликовый цилиндрический
...
- **J** — серия ширины  (B = 19 мм для этого размера)
...
- SKF: NJ209-2RSH (H = Heavy duty уплотнение)
- FAG: NJ209.2RSR (точка вместо дефиса)
- NTN: NJ209LLU (LLU = низкое трение)
- NSK: NJ209DDU (DDU = двойное уплотнение)
...
|---------------|-------------|------------|
| SKF | NJ209 | Премиум качество, Heavy duty уплотнение |
| FAG | NJ209 | Премиум, точка вместо дефиса |
| NTN | NJ209 | LLU = низкое трение уплотнения |
| NSK | NJ209 | DDU = двойное уплотнение |
| ГОСТ | 42309 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **NJ209-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **NJ209-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **NJ209** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- NJ08-2RS — другой d (40 мм вместо 45 мм) — не сядет на вал
- NJ10-2RS — другой d (50 мм вместо 45 мм) — не сядет на вал

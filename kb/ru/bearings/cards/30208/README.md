---
id: KB-RU-000143
title: "30208 — подшипник роликовый конический"
topic: bearings-card
...
# 30208 — подшипник роликовый конический
...
**Предельные обороты**: 8000 об/мин (с консистентной смазкой; масляная: 11000 об/мин)
...
| NTN | 30208 |  |
| NSK | 30208 |  |
| ГОСТ | 7208 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **30208-2RS**: с уплотнениями — для загрязнённых условий
- **30208-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- 3007 — другой d (35 мм вместо 40 мм) — не сядет на вал
- 3009 — другой d (45 мм вместо 40 мм) — не сядет на вал
...
- Применение на оборотах выше 8000 → перегрев

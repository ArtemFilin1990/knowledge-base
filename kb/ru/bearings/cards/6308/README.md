---
id: KB-RU-000106
title: "6308 — подшипник шариковый радиальный"
topic: bearings-card
...
designation:
  base: "6308"
  suffixes: []
dims: {d: 40, D: 90, B: 23.0, unit: "mm"}
standards: ["ISO 15", "ISO 281", "ГОСТ 520-2011"]
equivalents:
  - {manufacturer: "SKF", code: "6308"}
  - {manufacturer: "FAG", code: "6308"}
  - {manufacturer: "NTN", code: "6308"}
  - {manufacturer: "NSK", code: "6308"}
  - {manufacturer: "ГОСТ", code: "308"}
load_capacity:
  dynamic_C_kN: 41.0
  static_C0_kN: 22.4
  rpm_limit: 7500
...
# 6308 — подшипник шариковый радиальный
...
- **3** — серия ширины средняя (B = 23.0 мм для этого размера)
...
| NTN | 6308 |  |
| NSK | 6308 |  |
| ГОСТ | 308 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **6308-2RS**: с уплотнениями — для загрязнённых условий
- **6308-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 6208 — другой D (80 мм вместо 90 мм) — не войдёт в корпус
- 6307 — другой d (35 мм вместо 40 мм) — не сядет на вал
- 6309 — другой d (45 мм вместо 40 мм) — не сядет на вал

---
id: KB-RU-000065
title: "NJ202-2RS — подшипник роликовый цилиндрический"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "NJ202"}
  - {manufacturer: "FAG", code: "NJ202"}
  - {manufacturer: "NTN", code: "NJ202"}
  - {manufacturer: "NSK", code: "NJ202"}
  - {manufacturer: "ГОСТ", code: "42302"}
load_capacity:
  dynamic_C_kN: 13.5
  static_C0_kN: 10.4
  rpm_limit: 16000
...
# NJ202-2RS — подшипник роликовый цилиндрический
...
**Базовое обозначение**: NJ202
- **N** — серия роликовых цилиндрических
- **J** — серия ширины  (B = 11 мм для этого размера)
...
- SKF: NJ202-2RSH (H = Heavy duty уплотнение)
- FAG: NJ202.2RSR (точка вместо дефиса)
- NTN: NJ202LLU (LLU = низкое трение)
- NSK: NJ202DDU (DDU = двойное уплотнение)
...
- Серия NJxx (): стандартная серия для d=15 мм
- Другие зазоры: NJ202-2RS C3 — размеры те же, но зазор увеличен
...
|---------------|-------------|------------|
| SKF | NJ202 | Премиум качество, Heavy duty уплотнение |
| FAG | NJ202 | Премиум, точка вместо дефиса |
| NTN | NJ202 | LLU = низкое трение уплотнения |
| NSK | NJ202 | DDU = двойное уплотнение |
| ГОСТ | 42302 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **NJ202-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **NJ202-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **NJ202** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- NJ13-2RS — другой d (13 мм вместо 15 мм) — не сядет на вал
- NJ18-2RS — другой d (18 мм вместо 15 мм) — не сядет на вал

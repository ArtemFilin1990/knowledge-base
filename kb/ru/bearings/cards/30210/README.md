---
id: KB-RU-000145
title: "30210 — подшипник роликовый конический"
topic: bearings-card
...
# 30210 — подшипник роликовый конический
...
**Режимы работы**:
- Обороты: 650–6500 об/мин (оптимум 650–2166)
...
**Предельные обороты**: 6500 об/мин (с консистентной смазкой; масляная: 8500 об/мин)
...
| NTN | 30210 |  |
| NSK | 30210 |  |
| ГОСТ | 7210 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **30210-2RS**: с уплотнениями — для загрязнённых условий
- **30210-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- 3009 — другой d (45 мм вместо 50 мм) — не сядет на вал
- 3011 — другой d (55 мм вместо 50 мм) — не сядет на вал
...
- Применение на оборотах выше 6500 → перегрев

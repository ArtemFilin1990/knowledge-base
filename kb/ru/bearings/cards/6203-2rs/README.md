---
id: KB-RU-000030
title: "6203-2RS — подшипник шариковый радиальный"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "6203"}
  - {manufacturer: "FAG", code: "6203"}
  - {manufacturer: "NTN", code: "6203"}
  - {manufacturer: "NSK", code: "6203"}
  - {manufacturer: "ГОСТ", code: "203"}
load_capacity:
  dynamic_C_kN: 9.56
  static_C0_kN: 4.75
  rpm_limit: 14400
...
# 6203-2RS — подшипник шариковый радиальный
...
- SKF: 6203-2RSH (H = Heavy duty уплотнение)
- FAG: 6203.2RSR (точка вместо дефиса)
- NTN: 6203LLU (LLU = низкое трение)
- NSK: 6203DDU (DDU = двойное уплотнение)
...
- Серия 62xx (лёгкая): стандартная серия для d=17 мм
- Другие зазоры: 6203-2RS C3 — размеры те же, но зазор увеличен
...
**Статическая грузоподъёмность** (C0): 4.75 кН (≈ 484 кгс)
...
- L10 = (9560 / 500)³ × 10⁶ = 6989 × 10⁶ оборотов
- L10h = 6989 × 10⁶ / (60 × 1500) ≈ 77664 часов
...
|---------------|-------------|------------|
| SKF | 6203 | Премиум качество, Heavy duty уплотнение |
| FAG | 6203 | Премиум, точка вместо дефиса |
| NTN | 6203 | LLU = низкое трение уплотнения |
| NSK | 6203 | DDU = двойное уплотнение |
| ГОСТ | 203 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **6203-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **6203-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **6203** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
**Нельзя заменять на**:
- 6303-2RS — другой D (50 мм вместо 40 мм) — не войдёт в корпус
- 6202-2RS — другой d (15 мм вместо 17 мм) — не сядет на вал
- 6204-2RS — другой d (20 мм вместо 17 мм) — не сядет на вал

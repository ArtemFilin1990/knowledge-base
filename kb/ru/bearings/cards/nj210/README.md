---
id: KB-RU-000136
title: "NJ210 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NJ210 — подшипник роликовый цилиндрический
...
- **J** — серия ширины  (B = 20.0 мм для этого размера)
...
| NTN | NJ210 |  |
| NSK | NJ210 |  |
| ГОСТ | 42310 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NJ210-2RS**: с уплотнениями — для загрязнённых условий
- **NJ210-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 62210 — другой D (90 мм вместо 90 мм) — не войдёт в корпус
- NJ09 — другой d (45 мм вместо 50 мм) — не сядет на вал
- NJ11 — другой d (55 мм вместо 50 мм) — не сядет на вал

---
id: KB-RU-000158
title: "7212-B — подшипник шариковый радиально-упорный"
topic: bearings-card
...
# 7212-B — подшипник шариковый радиально-упорный
...
- SKF: 7212 BEP (BEP = полиамидный сепаратор, 40° контакт)
- FAG: 7212-B-XL-TVP (B = 40°, XL = усиленный, TVP = полиамидный сепаратор)
- NTN: 7212B (B = 40° угол контакта)
- NSK: 7212B (B = 40° угол контакта)
...
**Предельные обороты**: 5300 об/мин (с консистентной смазкой; масляная смазка: 7500 об/мин)
...
|---------------|-------------|------------|
| SKF | 7212 BEP | BEP = полиамидный сепаратор, 40° контакт |
| FAG | 7212-B-TVP | B = 40°, XL = усиленный, TVP = полиамидный сепаратор |
| NTN | 7212B | B = 40° угол контакта |
| NSK | 7212B | B = 40° угол контакта |
| ГОСТ | 36212 | Отечественный, код "46" = радиально-упорный |

**Функциональные аналоги** (допустимые отличия):
- **7212-B-2RS**: с уплотнениями — для загрязнённых условий, ниже обороты
- **7212** (угол 25°): меньше осевая, больше радиальная грузоподъёмность
...
**Нельзя заменять на**:
- 7211-B — другой d (55 мм вместо 60 мм) — не сядет на вал
- 7213-B — другой d (65 мм вместо 60 мм) — не сядет на вал

**Допустимые замены с оговорками**:
- **7212-A → 7212-B**: допустимо, но изменится распределение нагрузок

---
id: KB-RU-000098
title: "6300 — подшипник шариковый радиальный"
topic: bearings-card
...
# 6300 — подшипник шариковый радиальный
...
- **3** — серия ширины средняя (B = 11.0 мм для этого размера)
...
| NTN | 6300 |  |
| NSK | 6300 |  |
| ГОСТ | 300 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **6300-2RS**: с уплотнениями — для загрязнённых условий
- **6300-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 6200 — другой D (25 мм вместо 35 мм) — не войдёт в корпус
- 6313 — другой d (13 мм вместо 10 мм) — не сядет на вал

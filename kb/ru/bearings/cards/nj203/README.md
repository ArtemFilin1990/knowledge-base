---
id: KB-RU-000129
title: "NJ203 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NJ203 — подшипник роликовый цилиндрический
...
- **J** — серия ширины  (B = 12.0 мм для этого размера)
...
| NTN | NJ203 |  |
| NSK | NJ203 |  |
| ГОСТ | 42303 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NJ203-2RS**: с уплотнениями — для загрязнённых условий
- **NJ203-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 62203 — другой D (40 мм вместо 40 мм) — не войдёт в корпус
- NJ02 — другой d (15 мм вместо 17 мм) — не сядет на вал
- NJ04 — другой d (20 мм вместо 17 мм) — не сядет на вал

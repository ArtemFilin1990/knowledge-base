---
id: KB-RU-000054
title: "6309-2RS — подшипник шариковый радиальный"
topic: bearings-card
...
created: 2026-02-06
updated: 2026-02-06
aliases: ["6309 2rs", "6309-2RSH", "6309DDU"]
designation:
  base: "6309"
  suffixes: ["2RS"]
dims: {d: 45, D: 100, B: 25, unit: "mm"}
standards: ["ISO 15", "ISO 281", "ГОСТ 520-2011"]
equivalents:
  - {manufacturer: "SKF", code: "6309-2RSH"}
  - {manufacturer: "FAG", code: "6309.2RSR"}
  - {manufacturer: "NTN", code: "6309LLU"}
  - {manufacturer: "NSK", code: "6309DDU"}
  - {manufacturer: "ГОСТ", code: "180309"}
load_capacity:
  dynamic_C_kN: 48.0
  static_C0_kN: 26.5
  rpm_limit: 5360
...
# 6309-2RS — подшипник шариковый радиальный
...
- **3** — серия ширины средняя (B = 25 мм для этого размера)
...
- SKF: 6309-2RSH (H = Heavy duty уплотнение)
- FAG: 6309.2RSR (точка вместо дефиса)
- NTN: 6309LLU (LLU = низкое трение)
- NSK: 6309DDU (DDU = двойное уплотнение)
...
|---------------|-------------|------------|
| SKF | 6309-2RSH | Премиум качество, Heavy duty уплотнение |
| FAG | 6309.2RSR | Премиум, точка вместо дефиса |
| NTN | 6309LLU | LLU = низкое трение уплотнения |
| NSK | 6309DDU | DDU = двойное уплотнение |
| ГОСТ | 180309 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **6309-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **6309-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **6309** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
**Нельзя заменять на**:
- 6209-2RS — другой D (90 мм вместо 100 мм) — не войдёт в корпус
- 6308-2RS — другой d (40 мм вместо 45 мм) — не сядет на вал
- 6310-2RS — другой d (50 мм вместо 45 мм) — не сядет на вал

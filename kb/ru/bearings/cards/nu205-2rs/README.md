---
id: KB-RU-000059
title: "NU205-2RS — подшипник роликовый цилиндрический"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "NU205"}
  - {manufacturer: "FAG", code: "NU205"}
  - {manufacturer: "NTN", code: "NU205"}
  - {manufacturer: "NSK", code: "NU205"}
  - {manufacturer: "ГОСТ", code: "32305"}
load_capacity:
  dynamic_C_kN: 29.5
  static_C0_kN: 23.2
  rpm_limit: 10400
...
# NU205-2RS — подшипник роликовый цилиндрический
...
**Базовое обозначение**: NU205
- **N** — серия роликовых цилиндрических
- **U** — серия ширины  (B = 15 мм для этого размера)
...
- SKF: NU205-2RSH (H = Heavy duty уплотнение)
- FAG: NU205.2RSR (точка вместо дефиса)
- NTN: NU205LLU (LLU = низкое трение)
- NSK: NU205DDU (DDU = двойное уплотнение)
...
- Серия NUxx (): стандартная серия для d=25 мм
- Другие зазоры: NU205-2RS C3 — размеры те же, но зазор увеличен
...
|---------------|-------------|------------|
| SKF | NU205 | Премиум качество, Heavy duty уплотнение |
| FAG | NU205 | Премиум, точка вместо дефиса |
| NTN | NU205 | LLU = низкое трение уплотнения |
| NSK | NU205 | DDU = двойное уплотнение |
| ГОСТ | 32305 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **NU205-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **NU205-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **NU205** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- NU04-2RS — другой d (20 мм вместо 25 мм) — не сядет на вал
- NU06-2RS — другой d (30 мм вместо 25 мм) — не сядет на вал

---
id: KB-RU-000051
title: "7208-2RS — подшипник шариковый радиально-упорный"
topic: bearings-card
...
created: 2026-02-06
updated: 2026-02-06
aliases: ["7208 2rs", "7208 BEP", "7208B"]
designation:
  base: "7208"
  suffixes: ["2RS"]
...
# 7208-2RS — подшипник шариковый радиально-упорный
...
- SKF: 7208-2RSH (H = Heavy duty уплотнение)
- FAG: 7208.2RSR (точка вместо дефиса)
- NTN: 7208LLU (LLU = низкое трение)
- NSK: 7208DDU (DDU = двойное уплотнение)
...
|---------------|-------------|------------|
| SKF | 7208 BEP | Премиум качество, Heavy duty уплотнение |
| FAG | 7208-B-TVP | Премиум, точка вместо дефиса |
| NTN | 7208B | LLU = низкое трение уплотнения |
| NSK | 7208B | DDU = двойное уплотнение |
| ГОСТ | 36208 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **7208-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **7208-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **7208** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
**Нельзя заменять на**:
- 7207-2RS — другой d (35 мм вместо 40 мм) — не сядет на вал
- 7209-2RS — другой d (45 мм вместо 40 мм) — не сядет на вал

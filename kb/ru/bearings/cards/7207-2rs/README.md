---
id: KB-RU-000050
title: "7207-2RS — подшипник шариковый радиально-упорный"
topic: bearings-card
...
created: 2026-02-06
updated: 2026-02-06
aliases: ["7207 2rs", "7207 BEP", "7207B"]
designation:
  base: "7207"
  suffixes: ["2RS"]
dims: {d: 35, D: 72, B: 17, unit: "mm"}
standards: ["ISO 15", "ISO 281", "ГОСТ 520-2011"]
equivalents:
  - {manufacturer: "SKF", code: "7207 BEP"}
  - {manufacturer: "FAG", code: "7207-B-TVP"}
  - {manufacturer: "NTN", code: "7207B"}
  - {manufacturer: "NSK", code: "7207B"}
  - {manufacturer: "ГОСТ", code: "36207"}
load_capacity:
  dynamic_C_kN: 25.5
  static_C0_kN: 15.3
  rpm_limit: 7600
...
# 7207-2RS — подшипник шариковый радиально-упорный
...
**Базовое обозначение**: 7207
- **7** — серия шариковых радиально-упорных (angular contact)
- **2** — серия ширины лёгкая (B = 17 мм для этого размера)
...
- SKF: 7207-2RSH (H = Heavy duty уплотнение)
- FAG: 7207.2RSR (точка вместо дефиса)
- NTN: 7207LLU (LLU = низкое трение)
- NSK: 7207DDU (DDU = двойное уплотнение)
...
- НЕ взаимозаменяем с 6207 — другой тип нагрузки и требования к монтажу
...
**Динамическая грузоподъёмность** (C): 25.5 кН (≈ 2600 кгс)
**Статическая грузоподъёмность** (C0): 15.3 кН (≈ 1560 кгс)
...
- Радиальная нагрузка Fr = 1300 Н
- Осевая нагрузка Fa = 650 Н
- Частота вращения n = 1500 об/мин
- X = 0.57, Y = 0.93 (для угла 40°, Fa/Fr > e)
- P = 0.57 × 1300 + 0.93 × 650 = 1345 Н
- L10 = (C / P)³ × 10⁶ оборотов
- L10h = L10 / (60 × n)
...
|---------------|-------------|------------|
| SKF | 7207 BEP | Премиум качество, Heavy duty уплотнение |
| FAG | 7207-B-TVP | Премиум, точка вместо дефиса |
| NTN | 7207B | LLU = низкое трение уплотнения |
| NSK | 7207B | DDU = двойное уплотнение |
| ГОСТ | 36207 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **7207-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **7207-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **7207** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
**Нельзя заменять на**:
- 7206-2RS — другой d (30 мм вместо 35 мм) — не сядет на вал
- 7208-2RS — другой d (40 мм вместо 35 мм) — не сядет на вал
...
- Замена на радиальный подшипник 6207 → отказ при осевых нагрузках

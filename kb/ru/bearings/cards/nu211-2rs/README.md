---
id: KB-RU-000173
title: "NU211-2RS — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NU211-2RS — подшипник роликовый цилиндрический
...
- SKF: NU211-2RSH (H = Heavy duty уплотнение)
- FAG: NU211.2RSR (точка вместо дефиса)
- NTN: NU211LLU (LLU = низкое трение)
- NSK: NU211DDU (DDU = двойное уплотнение)
...
|---------------|-------------|------------|
| SKF | NU211 | Премиум качество, Heavy duty уплотнение |
| FAG | NU211 | Премиум, точка вместо дефиса |
| NTN | NU211 | LLU = низкое трение уплотнения |
| NSK | NU211 | DDU = двойное уплотнение |
| ГОСТ | 32311 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **NU211-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **NU211-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **NU211** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- NU10-2RS — другой d (50 мм вместо 55 мм) — не сядет на вал
- NU12-2RS — другой d (60 мм вместо 55 мм) — не сядет на вал

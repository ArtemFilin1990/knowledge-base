---
id: KB-RU-000178
title: "30212-2RS — подшипник роликовый конический"
topic: bearings-card
...
# 30212-2RS — подшипник роликовый конический
...
**Режимы работы**:
- Обороты: 448–4480 об/мин (оптимум 448–1493)
...
- SKF: 30212-2RSH (H = Heavy duty уплотнение)
- FAG: 30212.2RSR (точка вместо дефиса)
- NTN: 30212LLU (LLU = низкое трение)
- NSK: 30212DDU (DDU = двойное уплотнение)
...
**Предельные обороты**: 4480 об/мин (с уплотнениями; открытый: 5600 об/мин)
...
|---------------|-------------|------------|
| SKF | 30212 | Премиум качество, Heavy duty уплотнение |
| FAG | 30212 | Премиум, точка вместо дефиса |
| NTN | 30212 | LLU = низкое трение уплотнения |
| NSK | 30212 | DDU = двойное уплотнение |
| ГОСТ | 7212 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **30212-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **30212-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **30212** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- 3011-2RS — другой d (55 мм вместо 60 мм) — не сядет на вал
- 3013-2RS — другой d (65 мм вместо 60 мм) — не сядет на вал
...
- Применение на оборотах выше 4480 → перегрев уплотнений

---
id: KB-RU-000070
title: "NJ207-2RS — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NJ207-2RS — подшипник роликовый цилиндрический
...
- **J** — серия ширины  (B = 17 мм для этого размера)
...
- SKF: NJ207-2RSH (H = Heavy duty уплотнение)
- FAG: NJ207.2RSR (точка вместо дефиса)
- NTN: NJ207LLU (LLU = низкое трение)
- NSK: NJ207DDU (DDU = двойное уплотнение)
...
|---------------|-------------|------------|
| SKF | NJ207 | Премиум качество, Heavy duty уплотнение |
| FAG | NJ207 | Премиум, точка вместо дефиса |
| NTN | NJ207 | LLU = низкое трение уплотнения |
| NSK | NJ207 | DDU = двойное уплотнение |
| ГОСТ | 42307 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **NJ207-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **NJ207-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **NJ207** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- NJ06-2RS — другой d (30 мм вместо 35 мм) — не сядет на вал
- NJ08-2RS — другой d (40 мм вместо 35 мм) — не сядет на вал

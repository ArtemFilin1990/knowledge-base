---
id: KB-RU-000116
title: "7210-B — подшипник шариковый радиально-упорный"
topic: bearings-card
...
# 7210-B — подшипник шариковый радиально-упорный
...
- SKF: 7210 BEP (BEP = полиамидный сепаратор, 40° контакт)
- FAG: 7210-B-XL-TVP (B = 40°, XL = усиленный, TVP = полиамидный сепаратор)
- NTN: 7210B (B = 40° угол контакта)
- NSK: 7210B (B = 40° угол контакта)
...
**Предельные обороты**: 6700 об/мин (с консистентной смазкой; масляная смазка: 9000 об/мин)
...
|---------------|-------------|------------|
| SKF | 7210 BEP | BEP = полиамидный сепаратор, 40° контакт |
| FAG | 7210-B-TVP | B = 40°, XL = усиленный, TVP = полиамидный сепаратор |
| NTN | 7210B | B = 40° угол контакта |
| NSK | 7210B | B = 40° угол контакта |
| ГОСТ | 36210 | Отечественный, код "46" = радиально-упорный |

**Функциональные аналоги** (допустимые отличия):
- **7210-B-2RS**: с уплотнениями — для загрязнённых условий, ниже обороты
- **7210** (угол 25°): меньше осевая, больше радиальная грузоподъёмность
...
**Нельзя заменять на**:
- 7209-B — другой d (45 мм вместо 50 мм) — не сядет на вал
- 7211-B — другой d (55 мм вместо 50 мм) — не сядет на вал

**Допустимые замены с оговорками**:
- **7210-A → 7210-B**: допустимо, но изменится распределение нагрузок

---
id: KB-RU-000090
title: "6203 — подшипник шариковый радиальный"
topic: bearings-card
...
# 6203 — подшипник шариковый радиальный
...
| NTN | 6203 |  |
| NSK | 6203 |  |
| ГОСТ | 203 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **6203-2RS**: с уплотнениями — для загрязнённых условий
- **6203-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 6303 — другой D (50 мм вместо 40 мм) — не войдёт в корпус
- 6202 — другой d (15 мм вместо 17 мм) — не сядет на вал
- 6204 — другой d (20 мм вместо 17 мм) — не сядет на вал

---
id: KB-RU-000094
title: "6207 — подшипник шариковый радиальный"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "6207"}
  - {manufacturer: "FAG", code: "6207"}
  - {manufacturer: "NTN", code: "6207"}
  - {manufacturer: "NSK", code: "6207"}
  - {manufacturer: "ГОСТ", code: "207"}
load_capacity:
  dynamic_C_kN: 25.5
  static_C0_kN: 13.7
  rpm_limit: 9500
...
# 6207 — подшипник шариковый радиальный
...
| NTN | 6207 |  |
| NSK | 6207 |  |
| ГОСТ | 207 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **6207-2RS**: с уплотнениями — для загрязнённых условий
- **6207-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 6307 — другой D (82 мм вместо 72 мм) — не войдёт в корпус
- 6206 — другой d (30 мм вместо 35 мм) — не сядет на вал
- 6208 — другой d (40 мм вместо 35 мм) — не сядет на вал

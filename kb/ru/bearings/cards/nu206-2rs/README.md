---
id: KB-RU-000060
title: "NU206-2RS — подшипник роликовый цилиндрический"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "NU206"}
  - {manufacturer: "FAG", code: "NU206"}
  - {manufacturer: "NTN", code: "NU206"}
  - {manufacturer: "NSK", code: "NU206"}
  - {manufacturer: "ГОСТ", code: "32306"}
load_capacity:
  dynamic_C_kN: 37.1
  static_C0_kN: 30.0
  rpm_limit: 8800
...
# NU206-2RS — подшипник роликовый цилиндрический
...
**Базовое обозначение**: NU206
- **N** — серия роликовых цилиндрических
- **U** — серия ширины  (B = 16 мм для этого размера)
...
- SKF: NU206-2RSH (H = Heavy duty уплотнение)
- FAG: NU206.2RSR (точка вместо дефиса)
- NTN: NU206LLU (LLU = низкое трение)
- NSK: NU206DDU (DDU = двойное уплотнение)
...
- Серия NUxx (): стандартная серия для d=30 мм
- Другие зазоры: NU206-2RS C3 — размеры те же, но зазор увеличен
...
|---------------|-------------|------------|
| SKF | NU206 | Премиум качество, Heavy duty уплотнение |
| FAG | NU206 | Премиум, точка вместо дефиса |
| NTN | NU206 | LLU = низкое трение уплотнения |
| NSK | NU206 | DDU = двойное уплотнение |
| ГОСТ | 32306 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **NU206-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **NU206-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **NU206** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- NU05-2RS — другой d (25 мм вместо 30 мм) — не сядет на вал
- NU07-2RS — другой d (35 мм вместо 30 мм) — не сядет на вал

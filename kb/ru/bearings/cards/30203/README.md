---
id: KB-RU-000138
title: "30203 — подшипник роликовый конический"
topic: bearings-card
...
# 30203 — подшипник роликовый конический
...
**Предельные обороты**: 16000 об/мин (с консистентной смазкой; масляная: 21000 об/мин)
...
| NTN | 30203 |  |
| NSK | 30203 |  |
| ГОСТ | 7203 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **30203-2RS**: с уплотнениями — для загрязнённых условий
- **30203-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- 3002 — другой d (15 мм вместо 17 мм) — не сядет на вал
- 3004 — другой d (20 мм вместо 17 мм) — не сядет на вал
...
- Применение на оборотах выше 16000 → перегрев

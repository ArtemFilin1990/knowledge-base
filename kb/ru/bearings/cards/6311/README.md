---
id: KB-RU-000159
title: "6311 — подшипник шариковый радиальный"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "6311"}
  - {manufacturer: "FAG", code: "6311"}
  - {manufacturer: "NTN", code: "6311"}
  - {manufacturer: "NSK", code: "6311"}
  - {manufacturer: "ГОСТ", code: "311"}
load_capacity:
  dynamic_C_kN: 71.5
  static_C0_kN: 45.5
  rpm_limit: 5300
...
# 6311 — подшипник шариковый радиальный
...
| NTN | 6311 |  |
| NSK | 6311 |  |
| ГОСТ | 311 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **6311-2RS**: с уплотнениями — для загрязнённых условий
- **6311-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 6211 — другой D (110 мм вместо 120 мм) — не войдёт в корпус
- 6310 — другой d (50 мм вместо 55 мм) — не сядет на вал
- 6312 — другой d (60 мм вместо 55 мм) — не сядет на вал

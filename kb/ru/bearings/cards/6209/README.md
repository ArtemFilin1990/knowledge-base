---
id: KB-RU-000096
title: "6209 — подшипник шариковый радиальный"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "6209"}
  - {manufacturer: "FAG", code: "6209"}
  - {manufacturer: "NTN", code: "6209"}
  - {manufacturer: "NSK", code: "6209"}
  - {manufacturer: "ГОСТ", code: "209"}
load_capacity:
  dynamic_C_kN: 33.2
  static_C0_kN: 18.6
  rpm_limit: 7500
...
# 6209 — подшипник шариковый радиальный
...
| NTN | 6209 |  |
| NSK | 6209 |  |
| ГОСТ | 209 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **6209-2RS**: с уплотнениями — для загрязнённых условий
- **6209-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 6309 — другой D (95 мм вместо 85 мм) — не войдёт в корпус
- 6208 — другой d (40 мм вместо 45 мм) — не сядет на вал
- 6210 — другой d (50 мм вместо 45 мм) — не сядет на вал

---
id: KB-RU-000134
title: "NJ208 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NJ208 — подшипник роликовый цилиндрический
...
- **J** — серия ширины  (B = 18.0 мм для этого размера)
...
| NTN | NJ208 |  |
| NSK | NJ208 |  |
| ГОСТ | 42308 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NJ208-2RS**: с уплотнениями — для загрязнённых условий
- **NJ208-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- NJ07 — другой d (35 мм вместо 40 мм) — не сядет на вал
- NJ09 — другой d (45 мм вместо 40 мм) — не сядет на вал

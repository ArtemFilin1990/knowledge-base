---
id: KB-RU-000107
title: "7200-B — подшипник шариковый радиально-упорный"
topic: bearings-card
...
created: 2026-02-06
updated: 2026-02-06
aliases: ["7200 b", "7200 BEP", "7200B"]
designation:
  base: "7200"
  suffixes: ["B"]
dims: {d: 10, D: 30, B: 9.0, unit: "mm"}
...
# 7200-B — подшипник шариковый радиально-упорный
...
**Режимы работы**:
- Обороты: 2600–26000 об/мин (оптимум 2600–8666)
...
- **2** — серия ширины лёгкая (B = 9.0 мм для этого размера)
...
- SKF: 7200 BEP (BEP = полиамидный сепаратор, 40° контакт)
- FAG: 7200-B-XL-TVP (B = 40°, XL = усиленный, TVP = полиамидный сепаратор)
- NTN: 7200B (B = 40° угол контакта)
- NSK: 7200B (B = 40° угол контакта)
...
**Предельные обороты**: 26000 об/мин (с консистентной смазкой; масляная смазка: 34000 об/мин)
...
|---------------|-------------|------------|
| SKF | 7200 BEP | BEP = полиамидный сепаратор, 40° контакт |
| FAG | 7200-B-TVP | B = 40°, XL = усиленный, TVP = полиамидный сепаратор |
| NTN | 7200B | B = 40° угол контакта |
| NSK | 7200B | B = 40° угол контакта |
| ГОСТ | 36200 | Отечественный, код "46" = радиально-упорный |

**Функциональные аналоги** (допустимые отличия):
- **7200-B-2RS**: с уплотнениями — для загрязнённых условий, ниже обороты
- **7200** (угол 25°): меньше осевая, больше радиальная грузоподъёмность
...
**Нельзя заменять на**:
- 7213-B — другой d (13 мм вместо 10 мм) — не сядет на вал

**Допустимые замены с оговорками**:
- **7200-A → 7200-B**: допустимо, но изменится распределение нагрузок

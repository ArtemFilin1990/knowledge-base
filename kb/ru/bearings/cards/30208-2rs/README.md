---
id: KB-RU-000152
title: "30208-2RS — подшипник роликовый конический"
topic: bearings-card
...
designation:
  base: "30208"
  suffixes: ["2RS"]
dims: {d: 40, D: 80, B: 19.75, unit: "mm"}
standards: ["ISO 15", "ISO 281", "ГОСТ 520-2011"]
equivalents:
  - {manufacturer: "SKF", code: "30208"}
  - {manufacturer: "FAG", code: "30208"}
  - {manufacturer: "NTN", code: "30208"}
  - {manufacturer: "NSK", code: "30208"}
  - {manufacturer: "ГОСТ", code: "7208"}
load_capacity:
  dynamic_C_kN: 55.9
  static_C0_kN: 60.0
  rpm_limit: 6400
...
# 30208-2RS — подшипник роликовый конический
...
- SKF: 30208-2RSH (H = Heavy duty уплотнение)
- FAG: 30208.2RSR (точка вместо дефиса)
- NTN: 30208LLU (LLU = низкое трение)
- NSK: 30208DDU (DDU = двойное уплотнение)
...
- Серия 30xxx (): стандартная серия для d=40 мм
- Другие зазоры: 30208-2RS C3 — размеры те же, но зазор увеличен
...
**Динамическая грузоподъёмность** (C): 55.9 кН (≈ 5700 кгс)
**Статическая грузоподъёмность** (C0): 60.0 кН (≈ 6118 кгс)
**Предельные обороты**: 6400 об/мин (с уплотнениями; открытый: 8000 об/мин)
...
- L10 = (55900 / 2800)³ × 10⁶ = 21586 × 10⁶ оборотов
- L10h = 21586 × 10⁶ / (60 × 1500) ≈ 239848 часов
...
|---------------|-------------|------------|
| SKF | 30208 | Премиум качество, Heavy duty уплотнение |
| FAG | 30208 | Премиум, точка вместо дефиса |
| NTN | 30208 | LLU = низкое трение уплотнения |
| NSK | 30208 | DDU = двойное уплотнение |
| ГОСТ | 7208 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **30208-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **30208-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **30208** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- 3007-2RS — другой d (35 мм вместо 40 мм) — не сядет на вал
- 3009-2RS — другой d (45 мм вместо 40 мм) — не сядет на вал
...
- Применение на оборотах выше 6400 → перегрев уплотнений

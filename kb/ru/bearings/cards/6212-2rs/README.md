---
id: KB-RU-000168
title: "6212-2RS — подшипник шариковый радиальный"
topic: bearings-card
...
created: 2026-02-06
updated: 2026-02-06
aliases: ["6212 2rs", "6212-2RSH", "6212DDU"]
designation:
  base: "6212"
  suffixes: ["2RS"]
...
equivalents:
  - {manufacturer: "SKF", code: "6212-2RSH"}
  - {manufacturer: "FAG", code: "6212.2RSR"}
  - {manufacturer: "NTN", code: "6212LLU"}
  - {manufacturer: "NSK", code: "6212DDU"}
  - {manufacturer: "ГОСТ", code: "180212"}
load_capacity:
  dynamic_C_kN: 52.0
  static_C0_kN: 36.0
  rpm_limit: 4240
...
# 6212-2RS — подшипник шариковый радиальный
...
- SKF: 6212-2RSH (H = Heavy duty уплотнение)
- FAG: 6212.2RSR (точка вместо дефиса)
- NTN: 6212LLU (LLU = низкое трение)
- NSK: 6212DDU (DDU = двойное уплотнение)
...
|---------------|-------------|------------|
| SKF | 6212-2RSH | Премиум качество, Heavy duty уплотнение |
| FAG | 6212.2RSR | Премиум, точка вместо дефиса |
| NTN | 6212LLU | LLU = низкое трение уплотнения |
| NSK | 6212DDU | DDU = двойное уплотнение |
| ГОСТ | 180212 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **6212-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **6212-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **6212** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
**Нельзя заменять на**:
- 6312-2RS — другой D (120 мм вместо 110 мм) — не войдёт в корпус
- 6211-2RS — другой d (55 мм вместо 60 мм) — не сядет на вал
- 6213-2RS — другой d (65 мм вместо 60 мм) — не сядет на вал

---
id: KB-RU-000091
title: "6204 — подшипник шариковый радиальный"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "6204"}
  - {manufacturer: "FAG", code: "6204"}
  - {manufacturer: "NTN", code: "6204"}
  - {manufacturer: "NSK", code: "6204"}
  - {manufacturer: "ГОСТ", code: "204"}
load_capacity:
  dynamic_C_kN: 13.5
  static_C0_kN: 6.55
  rpm_limit: 15000
...
# 6204 — подшипник шариковый радиальный
...
| NTN | 6204 |  |
| NSK | 6204 |  |
| ГОСТ | 204 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **6204-2RS**: с уплотнениями — для загрязнённых условий
- **6204-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 6304 — другой D (57 мм вместо 47 мм) — не войдёт в корпус
- 6202 — другой d (15 мм вместо 20 мм) — не сядет на вал
- 6205 — другой d (25 мм вместо 20 мм) — не сядет на вал

---
id: KB-RU-000089
title: "6202 — подшипник шариковый радиальный"
topic: bearings-card
...
# 6202 — подшипник шариковый радиальный
...
| NTN | 6202 |  |
| NSK | 6202 |  |
| ГОСТ | 202 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **6202-2RS**: с уплотнениями — для загрязнённых условий
- **6202-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 6302 — другой D (45 мм вместо 35 мм) — не войдёт в корпус
- 6213 — другой d (13 мм вместо 15 мм) — не сядет на вал
- 6218 — другой d (18 мм вместо 15 мм) — не сядет на вал

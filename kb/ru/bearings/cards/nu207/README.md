---
id: KB-RU-000124
title: "NU207 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NU207 — подшипник роликовый цилиндрический
...
- **U** — серия ширины  (B = 17.0 мм для этого размера)
...
| NTN | NU207 |  |
| NSK | NU207 |  |
| ГОСТ | 32307 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NU207-2RS**: с уплотнениями — для загрязнённых условий
- **NU207-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- NU06 — другой d (30 мм вместо 35 мм) — не сядет на вал
- NU08 — другой d (40 мм вместо 35 мм) — не сядет на вал

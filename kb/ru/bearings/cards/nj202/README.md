---
id: KB-RU-000128
title: "NJ202 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NJ202 — подшипник роликовый цилиндрический
...
- **J** — серия ширины  (B = 11.0 мм для этого размера)
...
**Предельные обороты**: 20000 об/мин (с консистентной смазкой; масляная: 26000 об/мин)
...
| NTN | NJ202 |  |
| NSK | NJ202 |  |
| ГОСТ | 42302 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NJ202-2RS**: с уплотнениями — для загрязнённых условий
- **NJ202-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- NJ13 — другой d (13 мм вместо 15 мм) — не сядет на вал
- NJ18 — другой d (18 мм вместо 15 мм) — не сядет на вал
...
- Применение на оборотах выше 20000 → перегрев

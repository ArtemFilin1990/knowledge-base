---
id: KB-RU-000052
title: "7209-2RS — подшипник шариковый радиально-упорный"
topic: bearings-card
...
created: 2026-02-06
updated: 2026-02-06
aliases: ["7209 2rs", "7209 BEP", "7209B"]
designation:
  base: "7209"
  suffixes: ["2RS"]
...
# 7209-2RS — подшипник шариковый радиально-упорный
...
- SKF: 7209-2RSH (H = Heavy duty уплотнение)
- FAG: 7209.2RSR (точка вместо дефиса)
- NTN: 7209LLU (LLU = низкое трение)
- NSK: 7209DDU (DDU = двойное уплотнение)
...
|---------------|-------------|------------|
| SKF | 7209 BEP | Премиум качество, Heavy duty уплотнение |
| FAG | 7209-B-TVP | Премиум, точка вместо дефиса |
| NTN | 7209B | LLU = низкое трение уплотнения |
| NSK | 7209B | DDU = двойное уплотнение |
| ГОСТ | 36209 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **7209-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **7209-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **7209** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
**Нельзя заменять на**:
- 7208-2RS — другой d (40 мм вместо 45 мм) — не сядет на вал
- 7210-2RS — другой d (50 мм вместо 45 мм) — не сядет на вал

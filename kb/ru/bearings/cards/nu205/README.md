---
id: KB-RU-000122
title: "NU205 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NU205 — подшипник роликовый цилиндрический
...
- **U** — серия ширины  (B = 15.0 мм для этого размера)
...
| NTN | NU205 |  |
| NSK | NU205 |  |
| ГОСТ | 32305 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NU205-2RS**: с уплотнениями — для загрязнённых условий
- **NU205-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- NU04 — другой d (20 мм вместо 25 мм) — не сядет на вал
- NU06 — другой d (30 мм вместо 25 мм) — не сядет на вал

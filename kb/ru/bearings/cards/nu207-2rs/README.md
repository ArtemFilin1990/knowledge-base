---
id: KB-RU-000061
title: "NU207-2RS — подшипник роликовый цилиндрический"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "NU207"}
  - {manufacturer: "FAG", code: "NU207"}
  - {manufacturer: "NTN", code: "NU207"}
  - {manufacturer: "NSK", code: "NU207"}
  - {manufacturer: "ГОСТ", code: "32307"}
load_capacity:
  dynamic_C_kN: 48.0
  static_C0_kN: 38.0
  rpm_limit: 7600
...
# NU207-2RS — подшипник роликовый цилиндрический
...
**Базовое обозначение**: NU207
- **N** — серия роликовых цилиндрических
- **U** — серия ширины  (B = 17 мм для этого размера)
...
- SKF: NU207-2RSH (H = Heavy duty уплотнение)
- FAG: NU207.2RSR (точка вместо дефиса)
- NTN: NU207LLU (LLU = низкое трение)
- NSK: NU207DDU (DDU = двойное уплотнение)
...
- Серия NUxx (): стандартная серия для d=35 мм
- Другие зазоры: NU207-2RS C3 — размеры те же, но зазор увеличен
...
|---------------|-------------|------------|
| SKF | NU207 | Премиум качество, Heavy duty уплотнение |
| FAG | NU207 | Премиум, точка вместо дефиса |
| NTN | NU207 | LLU = низкое трение уплотнения |
| NSK | NU207 | DDU = двойное уплотнение |
| ГОСТ | 32307 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **NU207-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **NU207-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **NU207** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- NU06-2RS — другой d (30 мм вместо 35 мм) — не сядет на вал
- NU08-2RS — другой d (40 мм вместо 35 мм) — не сядет на вал

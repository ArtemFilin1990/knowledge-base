---
id: KB-RU-000174
title: "NU212-2RS — подшипник роликовый цилиндрический"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "NU212"}
  - {manufacturer: "FAG", code: "NU212"}
  - {manufacturer: "NTN", code: "NU212"}
  - {manufacturer: "NSK", code: "NU212"}
  - {manufacturer: "ГОСТ", code: "32312"}
load_capacity:
  dynamic_C_kN: 75.5
  static_C0_kN: 70.0
  rpm_limit: 4240
...
# NU212-2RS — подшипник роликовый цилиндрический
...
**Базовое обозначение**: NU212
- **N** — серия роликовых цилиндрических
- **U** — серия ширины  (B = 22.0 мм для этого размера)
...
- SKF: NU212-2RSH (H = Heavy duty уплотнение)
- FAG: NU212.2RSR (точка вместо дефиса)
- NTN: NU212LLU (LLU = низкое трение)
- NSK: NU212DDU (DDU = двойное уплотнение)
...
- Серия NUxx (): стандартная серия для d=60 мм
- Другие зазоры: NU212-2RS C3 — размеры те же, но зазор увеличен
...
|---------------|-------------|------------|
| SKF | NU212 | Премиум качество, Heavy duty уплотнение |
| FAG | NU212 | Премиум, точка вместо дефиса |
| NTN | NU212 | LLU = низкое трение уплотнения |
| NSK | NU212 | DDU = двойное уплотнение |
| ГОСТ | 32312 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **NU212-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **NU212-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **NU212** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- NU11-2RS — другой d (55 мм вместо 60 мм) — не сядет на вал
- NU13-2RS — другой d (65 мм вместо 60 мм) — не сядет на вал

---
id: KB-RU-000087
title: "6200 — подшипник шариковый радиальный"
topic: bearings-card
...
# 6200 — подшипник шариковый радиальный
...
**Предельные обороты**: 26000 об/мин (с консистентной смазкой; масляная: 34000 об/мин)
...
| NTN | 6200 |  |
| NSK | 6200 |  |
| ГОСТ | 200 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **6200-2RS**: с уплотнениями — для загрязнённых условий
- **6200-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 6300 — другой D (40 мм вместо 30 мм) — не войдёт в корпус
- 6213 — другой d (13 мм вместо 10 мм) — не сядет на вал
...
- Применение на оборотах выше 26000 → перегрев

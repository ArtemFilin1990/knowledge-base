---
id: KB-RU-000071
title: "NJ208-2RS — подшипник роликовый цилиндрический"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "NJ208"}
  - {manufacturer: "FAG", code: "NJ208"}
  - {manufacturer: "NTN", code: "NJ208"}
  - {manufacturer: "NSK", code: "NJ208"}
  - {manufacturer: "ГОСТ", code: "42308"}
load_capacity:
  dynamic_C_kN: 55.3
  static_C0_kN: 45.5
  rpm_limit: 6800
...
# NJ208-2RS — подшипник роликовый цилиндрический
...
**Базовое обозначение**: NJ208
- **N** — серия роликовых цилиндрических
- **J** — серия ширины  (B = 18 мм для этого размера)
...
- SKF: NJ208-2RSH (H = Heavy duty уплотнение)
- FAG: NJ208.2RSR (точка вместо дефиса)
- NTN: NJ208LLU (LLU = низкое трение)
- NSK: NJ208DDU (DDU = двойное уплотнение)
...
- Серия NJxx (): стандартная серия для d=40 мм
- Другие зазоры: NJ208-2RS C3 — размеры те же, но зазор увеличен
...
|---------------|-------------|------------|
| SKF | NJ208 | Премиум качество, Heavy duty уплотнение |
| FAG | NJ208 | Премиум, точка вместо дефиса |
| NTN | NJ208 | LLU = низкое трение уплотнения |
| NSK | NJ208 | DDU = двойное уплотнение |
| ГОСТ | 42308 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **NJ208-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **NJ208-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **NJ208** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- NJ07-2RS — другой d (35 мм вместо 40 мм) — не сядет на вал
- NJ09-2RS — другой d (45 мм вместо 40 мм) — не сядет на вал

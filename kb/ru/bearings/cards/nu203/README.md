---
id: KB-RU-000120
title: "NU203 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NU203 — подшипник роликовый цилиндрический
...
- **U** — серия ширины  (B = 12.0 мм для этого размера)
...
| NTN | NU203 |  |
| NSK | NU203 |  |
| ГОСТ | 32303 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NU203-2RS**: с уплотнениями — для загрязнённых условий
- **NU203-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- NU02 — другой d (15 мм вместо 17 мм) — не сядет на вал
- NU04 — другой d (20 мм вместо 17 мм) — не сядет на вал

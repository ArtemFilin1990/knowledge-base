---
id: KB-RU-000142
title: "30207 — подшипник роликовый конический"
topic: bearings-card
...
# 30207 — подшипник роликовый конический
...
**Режимы работы**:
- Обороты: 900–9000 об/мин (оптимум 900–3000)
...
**Предельные обороты**: 9000 об/мин (с консистентной смазкой; масляная: 12000 об/мин)
...
| NTN | 30207 |  |
| NSK | 30207 |  |
| ГОСТ | 7207 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **30207-2RS**: с уплотнениями — для загрязнённых условий
- **30207-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- 3006 — другой d (30 мм вместо 35 мм) — не сядет на вал
- 3008 — другой d (40 мм вместо 35 мм) — не сядет на вал
...
- Применение на оборотах выше 9000 → перегрев

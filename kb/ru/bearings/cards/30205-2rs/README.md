---
id: KB-RU-000149
title: "30205-2RS — подшипник роликовый конический"
topic: bearings-card
...
# 30205-2RS — подшипник роликовый конический
...
**Режимы работы**:
- Обороты: 960–9600 об/мин (оптимум 960–3200)
...
- SKF: 30205-2RSH (H = Heavy duty уплотнение)
- FAG: 30205.2RSR (точка вместо дефиса)
- NTN: 30205LLU (LLU = низкое трение)
- NSK: 30205DDU (DDU = двойное уплотнение)
...
**Предельные обороты**: 9600 об/мин (с уплотнениями; открытый: 12000 об/мин)
...
|---------------|-------------|------------|
| SKF | 30205 | Премиум качество, Heavy duty уплотнение |
| FAG | 30205 | Премиум, точка вместо дефиса |
| NTN | 30205 | LLU = низкое трение уплотнения |
| NSK | 30205 | DDU = двойное уплотнение |
| ГОСТ | 7205 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **30205-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **30205-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **30205** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- 3004-2RS — другой d (20 мм вместо 25 мм) — не сядет на вал
- 3006-2RS — другой d (30 мм вместо 25 мм) — не сядет на вал
...
- Применение на оборотах выше 9600 → перегрев уплотнений

---
id: KB-RU-000127
title: "NU210 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NU210 — подшипник роликовый цилиндрический
...
- **U** — серия ширины  (B = 20.0 мм для этого размера)
...
| NTN | NU210 |  |
| NSK | NU210 |  |
| ГОСТ | 32310 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NU210-2RS**: с уплотнениями — для загрязнённых условий
- **NU210-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- NU09 — другой d (45 мм вместо 50 мм) — не сядет на вал
- NU11 — другой d (55 мм вместо 50 мм) — не сядет на вал

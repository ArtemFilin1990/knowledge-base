---
id: KB-RU-000108
title: "7201-B — подшипник шариковый радиально-упорный"
topic: bearings-card
...
# 7201-B — подшипник шариковый радиально-упорный
...
- SKF: 7201 BEP (BEP = полиамидный сепаратор, 40° контакт)
- FAG: 7201-B-XL-TVP (B = 40°, XL = усиленный, TVP = полиамидный сепаратор)
- NTN: 7201B (B = 40° угол контакта)
- NSK: 7201B (B = 40° угол контакта)
...
**Предельные обороты**: 22000 об/мин (с консистентной смазкой; масляная смазка: 28000 об/мин)
...
|---------------|-------------|------------|
| SKF | 7201 BEP | BEP = полиамидный сепаратор, 40° контакт |
| FAG | 7201-B-TVP | B = 40°, XL = усиленный, TVP = полиамидный сепаратор |
| NTN | 7201B | B = 40° угол контакта |
| NSK | 7201B | B = 40° угол контакта |
| ГОСТ | 36201 | Отечественный, код "46" = радиально-упорный |

**Функциональные аналоги** (допустимые отличия):
- **7201-B-2RS**: с уплотнениями — для загрязнённых условий, ниже обороты
- **7201** (угол 25°): меньше осевая, больше радиальная грузоподъёмность
...
**Нельзя заменять на**:
- 7200-B — другой d (10 мм вместо 12 мм) — не сядет на вал
- 7202-B — другой d (15 мм вместо 12 мм) — не сядет на вал

**Допустимые замены с оговорками**:
- **7201-A → 7201-B**: допустимо, но изменится распределение нагрузок

---
id: KB-RU-000111
title: "7204-B — подшипник шариковый радиально-упорный"
topic: bearings-card
...
# 7204-B — подшипник шариковый радиально-упорный
...
- **2** — серия ширины лёгкая (B = 14.0 мм для этого размера)
...
- SKF: 7204 BEP (BEP = полиамидный сепаратор, 40° контакт)
- FAG: 7204-B-XL-TVP (B = 40°, XL = усиленный, TVP = полиамидный сепаратор)
- NTN: 7204B (B = 40° угол контакта)
- NSK: 7204B (B = 40° угол контакта)
...
**Предельные обороты**: 15000 об/мин (с консистентной смазкой; масляная смазка: 20000 об/мин)
...
|---------------|-------------|------------|
| SKF | 7204 BEP | BEP = полиамидный сепаратор, 40° контакт |
| FAG | 7204-B-TVP | B = 40°, XL = усиленный, TVP = полиамидный сепаратор |
| NTN | 7204B | B = 40° угол контакта |
| NSK | 7204B | B = 40° угол контакта |
| ГОСТ | 36204 | Отечественный, код "46" = радиально-упорный |

**Функциональные аналоги** (допустимые отличия):
- **7204-B-2RS**: с уплотнениями — для загрязнённых условий, ниже обороты
- **7204** (угол 25°): меньше осевая, больше радиальная грузоподъёмность
...
**Нельзя заменять на**:
- 7202-B — другой d (15 мм вместо 20 мм) — не сядет на вал
- 7205-B — другой d (25 мм вместо 20 мм) — не сядет на вал

**Допустимые замены с оговорками**:
- **7204-A → 7204-B**: допустимо, но изменится распределение нагрузок

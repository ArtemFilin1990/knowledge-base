---
id: KB-RU-000064
title: "NU210-2RS — подшипник роликовый цилиндрический"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "NU210"}
  - {manufacturer: "FAG", code: "NU210"}
  - {manufacturer: "NTN", code: "NU210"}
  - {manufacturer: "NSK", code: "NU210"}
  - {manufacturer: "ГОСТ", code: "32310"}
load_capacity:
  dynamic_C_kN: 65.5
  static_C0_kN: 58.0
  rpm_limit: 5360
...
# NU210-2RS — подшипник роликовый цилиндрический
...
**Базовое обозначение**: NU210
- **N** — серия роликовых цилиндрических
- **U** — серия ширины  (B = 20 мм для этого размера)
...
- SKF: NU210-2RSH (H = Heavy duty уплотнение)
- FAG: NU210.2RSR (точка вместо дефиса)
- NTN: NU210LLU (LLU = низкое трение)
- NSK: NU210DDU (DDU = двойное уплотнение)
...
- Серия NUxx (): стандартная серия для d=50 мм
- Другие зазоры: NU210-2RS C3 — размеры те же, но зазор увеличен
...
|---------------|-------------|------------|
| SKF | NU210 | Премиум качество, Heavy duty уплотнение |
| FAG | NU210 | Премиум, точка вместо дефиса |
| NTN | NU210 | LLU = низкое трение уплотнения |
| NSK | NU210 | DDU = двойное уплотнение |
| ГОСТ | 32310 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **NU210-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **NU210-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **NU210** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- NU09-2RS — другой d (45 мм вместо 50 мм) — не сядет на вал
- NU11-2RS — другой d (55 мм вместо 50 мм) — не сядет на вал

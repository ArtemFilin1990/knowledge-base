---
id: KB-RU-000099
title: "6301 — подшипник шариковый радиальный"
topic: bearings-card
...
# 6301 — подшипник шариковый радиальный
...
**Режимы работы**:
- Обороты: 1900–19000 об/мин (оптимум 1900–6333)
...
- **3** — серия ширины средняя (B = 12.0 мм для этого размера)
...
**Предельные обороты**: 19000 об/мин (с консистентной смазкой; масляная: 24000 об/мин)
...
| NTN | 6301 |  |
| NSK | 6301 |  |
| ГОСТ | 301 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **6301-2RS**: с уплотнениями — для загрязнённых условий
- **6301-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 6201 — другой D (27 мм вместо 37 мм) — не войдёт в корпус
- 6300 — другой d (10 мм вместо 12 мм) — не сядет на вал
- 6302 — другой d (15 мм вместо 12 мм) — не сядет на вал
...
- Применение на оборотах выше 19000 → перегрев

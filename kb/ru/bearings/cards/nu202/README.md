---
id: KB-RU-000119
title: "NU202 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NU202 — подшипник роликовый цилиндрический
...
- **U** — серия ширины  (B = 11.0 мм для этого размера)
...
| NTN | NU202 |  |
| NSK | NU202 |  |
| ГОСТ | 32302 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NU202-2RS**: с уплотнениями — для загрязнённых условий
- **NU202-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- NU13 — другой d (13 мм вместо 15 мм) — не сядет на вал
- NU18 — другой d (18 мм вместо 15 мм) — не сядет на вал

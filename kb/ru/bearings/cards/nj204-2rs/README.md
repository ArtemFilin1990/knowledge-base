---
id: KB-RU-000067
title: "NJ204-2RS — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NJ204-2RS — подшипник роликовый цилиндрический
...
- **J** — серия ширины  (B = 14 мм для этого размера)
...
- SKF: NJ204-2RSH (H = Heavy duty уплотнение)
- FAG: NJ204.2RSR (точка вместо дефиса)
- NTN: NJ204LLU (LLU = низкое трение)
- NSK: NJ204DDU (DDU = двойное уплотнение)
...
|---------------|-------------|------------|
| SKF | NJ204 | Премиум качество, Heavy duty уплотнение |
| FAG | NJ204 | Премиум, точка вместо дефиса |
| NTN | NJ204 | LLU = низкое трение уплотнения |
| NSK | NJ204 | DDU = двойное уплотнение |
| ГОСТ | 42304 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **NJ204-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **NJ204-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **NJ204** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- NJ02-2RS — другой d (15 мм вместо 20 мм) — не сядет на вал
- NJ05-2RS — другой d (25 мм вместо 20 мм) — не сядет на вал

---
id: KB-RU-000121
title: "NU204 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NU204 — подшипник роликовый цилиндрический
...
- **U** — серия ширины  (B = 14.0 мм для этого размера)
...
| NTN | NU204 |  |
| NSK | NU204 |  |
| ГОСТ | 32304 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NU204-2RS**: с уплотнениями — для загрязнённых условий
- **NU204-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- NU02 — другой d (15 мм вместо 20 мм) — не сядет на вал
- NU05 — другой d (25 мм вместо 20 мм) — не сядет на вал

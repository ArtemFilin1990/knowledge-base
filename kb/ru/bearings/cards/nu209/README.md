---
id: KB-RU-000126
title: "NU209 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NU209 — подшипник роликовый цилиндрический
...
- **U** — серия ширины  (B = 19.0 мм для этого размера)
...
| NTN | NU209 |  |
| NSK | NU209 |  |
| ГОСТ | 32309 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NU209-2RS**: с уплотнениями — для загрязнённых условий
- **NU209-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- NU08 — другой d (40 мм вместо 45 мм) — не сядет на вал
- NU10 — другой d (50 мм вместо 45 мм) — не сядет на вал

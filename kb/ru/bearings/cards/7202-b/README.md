---
id: KB-RU-000109
title: "7202-B — подшипник шариковый радиально-упорный"
topic: bearings-card
...
# 7202-B — подшипник шариковый радиально-упорный
...
**Режимы работы**:
- Обороты: 2000–20000 об/мин (оптимум 2000–6666)
...
- **2** — серия ширины лёгкая (B = 11.0 мм для этого размера)
...
- SKF: 7202 BEP (BEP = полиамидный сепаратор, 40° контакт)
- FAG: 7202-B-XL-TVP (B = 40°, XL = усиленный, TVP = полиамидный сепаратор)
- NTN: 7202B (B = 40° угол контакта)
- NSK: 7202B (B = 40° угол контакта)
...
**Предельные обороты**: 20000 об/мин (с консистентной смазкой; масляная смазка: 26000 об/мин)
...
- **7202-B-2RS**: с уплотнениями — для загрязнённых условий, ниже обороты
- **7202** (угол 25°): меньше осевая, больше радиальная грузоподъёмность
...
**Нельзя заменять на**:
- 7213-B — другой d (13 мм вместо 15 мм) — не сядет на вал
- 7218-B — другой d (18 мм вместо 15 мм) — не сядет на вал

**Допустимые замены с оговорками**:
- **7202-A → 7202-B**: допустимо, но изменится распределение нагрузок

---
id: KB-RU-000063
title: "NU209-2RS — подшипник роликовый цилиндрический"
topic: bearings-card
...
equivalents:
  - {manufacturer: "SKF", code: "NU209"}
  - {manufacturer: "FAG", code: "NU209"}
  - {manufacturer: "NTN", code: "NU209"}
  - {manufacturer: "NSK", code: "NU209"}
  - {manufacturer: "ГОСТ", code: "32309"}
load_capacity:
  dynamic_C_kN: 60.5
  static_C0_kN: 52.0
  rpm_limit: 6000
...
# NU209-2RS — подшипник роликовый цилиндрический
...
**Базовое обозначение**: NU209
- **N** — серия роликовых цилиндрических
- **U** — серия ширины  (B = 19 мм для этого размера)
...
- SKF: NU209-2RSH (H = Heavy duty уплотнение)
- FAG: NU209.2RSR (точка вместо дефиса)
- NTN: NU209LLU (LLU = низкое трение)
- NSK: NU209DDU (DDU = двойное уплотнение)
...
- Серия NUxx (): стандартная серия для d=45 мм
- Другие зазоры: NU209-2RS C3 — размеры те же, но зазор увеличен
...
|---------------|-------------|------------|
| SKF | NU209 | Премиум качество, Heavy duty уплотнение |
| FAG | NU209 | Премиум, точка вместо дефиса |
| NTN | NU209 | LLU = низкое трение уплотнения |
| NSK | NU209 | DDU = двойное уплотнение |
| ГОСТ | 32309 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **NU209-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **NU209-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **NU209** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
- NU08-2RS — другой d (40 мм вместо 45 мм) — не сядет на вал
- NU10-2RS — другой d (50 мм вместо 45 мм) — не сядет на вал

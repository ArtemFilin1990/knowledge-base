---
id: KB-RU-000163
title: "NJ211 — подшипник роликовый цилиндрический"
topic: bearings-card
...
# NJ211 — подшипник роликовый цилиндрический
...
| NTN | NJ211 |  |
| NSK | NJ211 |  |
| ГОСТ | 42311 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **NJ211-2RS**: с уплотнениями — для загрязнённых условий
- **NJ211-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
- NJ10 — другой d (50 мм вместо 55 мм) — не сядет на вал
- NJ12 — другой d (60 мм вместо 55 мм) — не сядет на вал

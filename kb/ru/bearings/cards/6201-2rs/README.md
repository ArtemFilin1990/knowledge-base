---
id: KB-RU-000028
title: "6201-2RS — подшипник шариковый радиальный"
topic: bearings-card
...
# 6201-2RS — подшипник шариковый радиальный
...
- SKF: 6201-2RSH (H = Heavy duty уплотнение)
- FAG: 6201.2RSR (точка вместо дефиса)
- NTN: 6201LLU (LLU = низкое трение)
- NSK: 6201DDU (DDU = двойное уплотнение)
...
|---------------|-------------|------------|
| SKF | 6201 | Премиум качество, Heavy duty уплотнение |
| FAG | 6201 | Премиум, точка вместо дефиса |
| NTN | 6201 | LLU = низкое трение уплотнения |
| NSK | 6201 | DDU = двойное уплотнение |
| ГОСТ | 201 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **6201-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **6201-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **6201** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
**Нельзя заменять на**:
- 6301-2RS — другой D (42 мм вместо 32 мм) — не войдёт в корпус
- 6200-2RS — другой d (10 мм вместо 12 мм) — не сядет на вал
- 6202-2RS — другой d (15 мм вместо 12 мм) — не сядет на вал
...
- Применение на оборотах выше 17600 → перегрев уплотнений

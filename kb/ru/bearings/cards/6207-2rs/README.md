---
id: KB-RU-000032
title: "6207-2RS — подшипник шариковый радиальный"
topic: bearings-card
...
created: 2026-02-06
updated: 2026-02-06
aliases: ["6207 2rs", "6207-2RSH", "6207DDU"]
designation:
  base: "6207"
  suffixes: ["2RS"]
...
equivalents:
  - {manufacturer: "SKF", code: "6207-2RSH"}
  - {manufacturer: "FAG", code: "6207.2RSR"}
  - {manufacturer: "NTN", code: "6207LLU"}
  - {manufacturer: "NSK", code: "6207DDU"}
  - {manufacturer: "ГОСТ", code: "180207"}
load_capacity:
  dynamic_C_kN: 25.5
  static_C0_kN: 13.7
  rpm_limit: 7600
...
# 6207-2RS — подшипник шариковый радиальный
...
- SKF: 6207-2RSH (H = Heavy duty уплотнение)
- FAG: 6207.2RSR (точка вместо дефиса)
- NTN: 6207LLU (LLU = низкое трение)
- NSK: 6207DDU (DDU = двойное уплотнение)
...
- Серия 62xx (лёгкая): стандартная серия для d=35 мм
- Другие зазоры: 6207-2RS C3 — размеры те же, но зазор увеличен
...
**Статическая грузоподъёмность** (C0): 13.7 кН (≈ 1397 кгс)
...
- Эквивалентная нагрузка P ≈ Fr = 1300 Н (малая осевая)
- L10 = (25500 / 1300)³ × 10⁶ = 7547 × 10⁶ оборотов
- L10h = 7547 × 10⁶ / (60 × 1500) ≈ 83858 часов
...
|---------------|-------------|------------|
| SKF | 6207-2RSH | Премиум качество, Heavy duty уплотнение |
| FAG | 6207.2RSR | Премиум, точка вместо дефиса |
| NTN | 6207LLU | LLU = низкое трение уплотнения |
| NSK | 6207DDU | DDU = двойное уплотнение |
| ГОСТ | 180207 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **6207-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **6207-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **6207** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
**Нельзя заменять на**:
- 6307-2RS — другой D (82 мм вместо 72 мм) — не войдёт в корпус
- 6206-2RS — другой d (30 мм вместо 35 мм) — не сядет на вал
- 6208-2RS — другой d (40 мм вместо 35 мм) — не сядет на вал

---
id: KB-RU-000113
title: "7207-B — подшипник шариковый радиально-упорный"
topic: bearings-card
...
# 7207-B — подшипник шариковый радиально-упорный
...
- **2** — серия ширины лёгкая (B = 17.0 мм для этого размера)
...
- SKF: 7207 BEP (BEP = полиамидный сепаратор, 40° контакт)
- FAG: 7207-B-XL-TVP (B = 40°, XL = усиленный, TVP = полиамидный сепаратор)
- NTN: 7207B (B = 40° угол контакта)
- NSK: 7207B (B = 40° угол контакта)
...
**Предельные обороты**: 9500 об/мин (с консистентной смазкой; масляная смазка: 13000 об/мин)
...
|---------------|-------------|------------|
| SKF | 7207 BEP | BEP = полиамидный сепаратор, 40° контакт |
| FAG | 7207-B-TVP | B = 40°, XL = усиленный, TVP = полиамидный сепаратор |
| NTN | 7207B | B = 40° угол контакта |
| NSK | 7207B | B = 40° угол контакта |
| ГОСТ | 36207 | Отечественный, код "46" = радиально-упорный |

**Функциональные аналоги** (допустимые отличия):
- **7207-B-2RS**: с уплотнениями — для загрязнённых условий, ниже обороты
- **7207** (угол 25°): меньше осевая, больше радиальная грузоподъёмность
...
**Нельзя заменять на**:
- 7206-B — другой d (30 мм вместо 35 мм) — не сядет на вал
- 7208-B — другой d (40 мм вместо 35 мм) — не сядет на вал

**Допустимые замены с оговорками**:
- **7207-A → 7207-B**: допустимо, но изменится распределение нагрузок

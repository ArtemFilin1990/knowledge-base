---
id: KB-RU-000112
title: "7206-B — подшипник шариковый радиально-упорный"
topic: bearings-card
...
# 7206-B — подшипник шариковый радиально-упорный
...
- SKF: 7206 BEP (BEP = полиамидный сепаратор, 40° контакт)
- FAG: 7206-B-XL-TVP (B = 40°, XL = усиленный, TVP = полиамидный сепаратор)
- NTN: 7206B (B = 40° угол контакта)
- NSK: 7206B (B = 40° угол контакта)
...
**Предельные обороты**: 11000 об/мин (с консистентной смазкой; масляная смазка: 15000 об/мин)
...
|---------------|-------------|------------|
| SKF | 7206 BEP | BEP = полиамидный сепаратор, 40° контакт |
| FAG | 7206-B-TVP | B = 40°, XL = усиленный, TVP = полиамидный сепаратор |
| NTN | 7206B | B = 40° угол контакта |
| NSK | 7206B | B = 40° угол контакта |
| ГОСТ | 36206 | Отечественный, код "46" = радиально-упорный |

**Функциональные аналоги** (допустимые отличия):
- **7206-B-2RS**: с уплотнениями — для загрязнённых условий, ниже обороты
- **7206** (угол 25°): меньше осевая, больше радиальная грузоподъёмность
...
**Нельзя заменять на**:
- 7205-B — другой d (25 мм вместо 30 мм) — не сядет на вал
- 7207-B — другой d (35 мм вместо 30 мм) — не сядет на вал

**Допустимые замены с оговорками**:
- **7206-A → 7206-B**: допустимо, но изменится распределение нагрузок

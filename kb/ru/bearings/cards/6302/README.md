---
id: KB-RU-000100
title: "6302 — подшипник шариковый радиальный"
topic: bearings-card
...
designation:
  base: "6302"
  suffixes: []
dims: {d: 15, D: 42, B: 13.0, unit: "mm"}
standards: ["ISO 15", "ISO 281", "ГОСТ 520-2011"]
equivalents:
  - {manufacturer: "SKF", code: "6302"}
  - {manufacturer: "FAG", code: "6302"}
  - {manufacturer: "NTN", code: "6302"}
  - {manufacturer: "NSK", code: "6302"}
  - {manufacturer: "ГОСТ", code: "302"}
load_capacity:
  dynamic_C_kN: 11.4
  static_C0_kN: 5.4
  rpm_limit: 17000
...
# 6302 — подшипник шариковый радиальный
...
**Режимы работы**:
- Обороты: 1700–17000 об/мин (оптимум 1700–5666)
...
- **3** — серия ширины средняя (B = 13.0 мм для этого размера)
...
- Серия 63xx (средняя): стандартная серия для d=15 мм
...
**Динамическая грузоподъёмность** (C): 11.4 кН (≈ 1162 кгс)
**Статическая грузоподъёмность** (C0): 5.4 кН (≈ 551 кгс)
**Предельные обороты**: 17000 об/мин (с консистентной смазкой; масляная: 22000 об/мин)
...
- Эквивалентная нагрузка P ≈ Fr = 600 Н (малая осевая)
- L10 = (11400 / 600)³ × 10⁶ = 6859 × 10⁶ оборотов
- L10h = 6859 × 10⁶ / (60 × 1500) ≈ 76211 часов
...
| NTN | 6302 |  |
| NSK | 6302 |  |
| ГОСТ | 302 | Отечественный аналог |

**Функциональные аналоги** (допустимые отличия):
- **6302-2RS**: с уплотнениями — для загрязнённых условий
- **6302-2Z**: с защитными шайбами — компромисс между защитой и оборотами
...
**Нельзя заменять на**:
- 6202 — другой D (32 мм вместо 42 мм) — не войдёт в корпус
- 6313 — другой d (13 мм вместо 15 мм) — не сядет на вал
- 6318 — другой d (18 мм вместо 15 мм) — не сядет на вал
...
- Применение на оборотах выше 17000 → перегрев

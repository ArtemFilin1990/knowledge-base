---
id: KB-RU-000042
title: "6308-2RS — подшипник шариковый радиальный"
topic: bearings-card
...
created: 2026-02-06
updated: 2026-02-06
aliases: ["6308 2rs", "6308-2RSH", "6308DDU"]
designation:
  base: "6308"
  suffixes: ["2RS"]
dims: {d: 40, D: 90, B: 23, unit: "mm"}
standards: ["ISO 15", "ISO 281", "ГОСТ 520-2011"]
equivalents:
  - {manufacturer: "SKF", code: "6308-2RSH"}
  - {manufacturer: "FAG", code: "6308.2RSR"}
  - {manufacturer: "NTN", code: "6308LLU"}
  - {manufacturer: "NSK", code: "6308DDU"}
  - {manufacturer: "ГОСТ", code: "180308"}
load_capacity:
  dynamic_C_kN: 41.0
  static_C0_kN: 22.4
  rpm_limit: 6000
...
# 6308-2RS — подшипник шариковый радиальный
...
**Базовое обозначение**: 6308
- **6** — серия шариковых радиальных однорядных (глубокий желоб)
- **3** — серия ширины средняя (B = 23 мм для этого размера)
...
- SKF: 6308-2RSH (H = Heavy duty уплотнение)
- FAG: 6308.2RSR (точка вместо дефиса)
- NTN: 6308LLU (LLU = низкое трение)
- NSK: 6308DDU (DDU = двойное уплотнение)
...
- Серия 63xx (средняя): стандартная серия для d=40 мм
- Другие зазоры: 6308-2RS C3 — размеры те же, но зазор увеличен
...
**Динамическая грузоподъёмность** (C): 41.0 кН (≈ 4181 кгс)
**Статическая грузоподъёмность** (C0): 22.4 кН (≈ 2284 кгс)
...
- Эквивалентная нагрузка P ≈ Fr = 2000 Н (малая осевая)
- L10 = (41000 / 2000)³ × 10⁶ = 8615 × 10⁶ оборотов
- L10h = 8615 × 10⁶ / (60 × 1500) ≈ 95723 часов
...
|---------------|-------------|------------|
| SKF | 6308-2RSH | Премиум качество, Heavy duty уплотнение |
| FAG | 6308.2RSR | Премиум, точка вместо дефиса |
| NTN | 6308LLU | LLU = низкое трение уплотнения |
| NSK | 6308DDU | DDU = двойное уплотнение |
| ГОСТ | 180308 | Отечественный, код "18" = двухстороннее уплотнение |

**Функциональные аналоги** (допустимые отличия):
- **6308-2RS C3**: увеличенный зазор — для работы при повышенных температурах
- **6308-2Z**: металлические шайбы вместо резины — меньшая защита, выше обороты
- **6308** (открытый): нет уплотнений — требуется внешняя защита, выше обороты
...
**Нельзя заменять на**:
- 6208-2RS — другой D (80 мм вместо 90 мм) — не войдёт в корпус
- 6307-2RS — другой d (35 мм вместо 40 мм) — не сядет на вал
- 6309-2RS — другой d (45 мм вместо 40 мм) — не сядет на вал
